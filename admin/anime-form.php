            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="url" id="poster_url" name="poster_url"
                           value="<?= $anime['poster'] ?? '' ?>"
                           class="input-field" placeholder="https://example.com/poster.jpg">
                    <p class="mt-1 text-sm text-gray-500">Masukkan link gambar poster (http/https). Jika sebelumnya memakai file lokal, Anda bisa ganti dengan URL.</p>
                    
                    <?php if (isset($anime['poster']) && $anime['poster']): ?>
                        <div class="mt-2">
                    ...
                    <?php else: ?>
                        <div class="mt-2">
                            <img id="posterPreview" src="<?= getImageUrl('') ?>" alt="Poster Preview" class="h-32 w-24 object-cover rounded">
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <!-- Background URL -->
                <div>
                    <label for="background_url" class="block text-sm font-medium text-gray-700 mb-2">
                        Background URL
                    </label>
                    <input type="url" id="background_url" name="background_url"
                           value="<?= $anime['background'] ?? '' ?>"
                           class="input-field" placeholder="https://example.com/background.jpg">
                    <p class="mt-1 text-sm text-gray-500">Masukkan link gambar background (http/https). Jika sebelumnya memakai file lokal, Anda bisa ganti dengan URL.</p>
                    
                    <?php if (isset($anime['background']) && $anime['background']): ?>
                        <div class="mt-2">
                    ...
                    <?php else: ?>
                        <div class="mt-2">
                            <img id="backgroundPreview" src="<?= getImageUrl('') ?>" alt="Background Preview" class="h-32 w-56 object-cover rounded">
                        </div>
                    <?php endif; ?>
                </div>
